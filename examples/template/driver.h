...
private:
    /// FIXME
    DEFINE_GET_SYMBOL_FUNC(GetSymbol, "CUDA_LIB",
                           std::vector<std::string>({"libcuda.so"}), // search name
                           std::vector<std::string>({"/usr/lib/x86_64-linux-gnu"})); // search path
...
public:
    ...
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuStreamCopyAttributes"), CUresult, StreamCopyAttributes, CUstream, dst, CUstream, src);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuStreamGetAttribute"), CUresult, StreamGetAttribute, CUstream, hStream, CUstreamAttrID, attr, CUstreamAttrValue *, value_out);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuStreamSetAttribute"), CUresult, StreamSetAttribute, CUstream, hStream, CUstreamAttrID, attr, const CUstreamAttrValue *, value);
    ...
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuGraphUpload"), CUresult, GraphUpload, CUgraphExec, hGraphExec, CUstream, hStream);
    DEFINE_STATIC_ADDRESS_CALL(GetSymbol("cuGraphLaunch"), CUresult, GraphLaunch, CUgraphExec, hGraphExec, CUstream, hStream);
